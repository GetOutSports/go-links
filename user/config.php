...
define( 'YOURLS_DB_USER', 'go-links' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', 'l?kOk`_a@e\*iJkF' );

/** The name of the database for YOURLS
 ** Use lower case letters [a-z], digits [0-9] and underscores [_] only */
define( 'YOURLS_DB_NAME', 'go_links' );
...
define( 'YOURLS_SITE', 'http://go.getout.sport' );
...
define( 'YOURLS_COOKIEKEY', 'fUP%%}Es)jS2#|_[MTHmHzbsUn[X0Laj~&x)ywms' );
